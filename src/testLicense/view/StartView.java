...
public class StartView {
	...
	public static void main(String[] args) throws ParseException, SQLException {
		...
		controller.updateFee(5, 50000);
		controller.selectAllTest();

		System.out.println("\n▶2) 인기있는 타로심리상담사자격증 시험이 1회 추가되었습니다.");
		controller.updateTest("타로심리상담사1급 5회", 85000, new SimpleDateFormat("yyyy-MM-dd").parse("2021-11-19"),
				new SimpleDateFormat("yyyy-MM-dd").parse("2021-12-22"), "한국직업능력진흥원", "02-465-9447",
				"http://www.pqi.or.kr/");
		controller.selectAllTest();
		...
		controller.updateTestUser(8, "010-5555-7776");
